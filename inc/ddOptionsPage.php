	...
	<!--div class="wrap"-->
		...
		<div class="ddcf-options-div">
			<div id="tabs">
				...
				<?php settings_fields( 'ddcf-settings-group' ); ?>
				<?php do_settings_fields( 'ddcf-settings-group', 'settings-section-id' ); ?>

				<div id="tabs-1">
					<p>
						<?php _e('Set, edit or view email settings. View or change captcha settings in security settings section. Enable user details logging in privacy settings section.', 'ddcf-plugin') ?><br />
					</p>
					<div id="accordion1">
						<h3>Security</h3>
						<div>
							<p>
								<strong><?php _e('Captcha type', 'ddcf-plugin') ?></strong>
                                                                <br /><br />
								<?php _e('Select the Captcha type:', 'ddcf-plugin') ?>
								<select name="ddcf_captcha_type" id="ddcf_captcha_type">
										...
										<option value="Simple Add" <?php if(get_option(ddcf_captcha_type, 'Simple Add')=='Simple Add') echo 'selected';?>>Simple Add</option>
										<option value="None" <?php if(get_option(ddcf_captcha_type)=='None') echo 'selected';?>>None (not recommended)</option>
								</select>
							</p>
                                                        <br />
							<p>
								<strong><?php _e('Google reCaptcha keys', 'ddcf-plugin') ?></strong>
								<br /><br />
                                                                <?php _e('To use the Google reCaptcha, you will need to sign up and get private and public keys. Signup is extremely quick and easy - see here: <a href="https://www.google.com/recaptcha/admin/create" target="_blank">https://www.google.com/recaptcha/admin/create</a>', 'ddcf-plugin') ?>
                                                                <br /><br />
                                                                <?php _e('Paste public key here:', 'ddcf-plugin') ?>
                                                                <br />
                                                                ...
                                                                <br />
                                                                <?php _e('Paste private key here:', 'ddcf-plugin') ?>
                                                                <br />
...
<textarea class="ddcf_textarea_input" name="ddcf_rec_updates_message" value="<?php echo get_option('ddcf_rec_updates_message'); ?>" id="ddcf_rec_updates_message" ><?php echo get_option('ddcf_rec_updates_message'); ?></textarea>
                                                        ...
                                                        <p>
                                                                ...
                                                                <?php _e('Save contact form user&#39;s IP address and geolocation information', 'ddcf-plugin') ?>
                                                                <br /><br />
                                                                <?php _e('Paste key here:', 'ddcf-plugin') ?>
                                                                <br />
						...
						<div>
							...
							<p>
								...
								<br /><br />
																...
																<?php _e('Send confirmation email', 'ddcf-plugin') ?>
                                                                <br /><br />
                                                                <?php
                                                                	_e('Confirmation email text:', 'ddcf-plugin');
							...
							<br /><br />
							<p>
								<strong><?php _e('Email Header', 'ddcf-plugin') ?></strong>
								<br /><br />
                                                                <?php _e('You can specify an image to display at the top of emails sent by the contact form. The URL should be in absolute format.', 'ddcf-plugin') ?>
                                                                <br /><br />
                                                                <?php _e('Image URL:', 'ddcf-plugin') ?>
				...
				<div id="tabs-2">
					<p>
						<?php _e('View or change user feedback options or make changes to the UI appearance.', 'ddcf-plugin') ?><br />
					</p>
					<div id="accordion2">
						<h3>User Feedback</h3>
						<div>
                                                    <p>
                                                            <strong><?php _e('Form sent action', 'ddcf-plugin') ?></strong>
                                                            <br /><br />
                                                            <?php
                                                                _e('Once the user has sucessfully sent their message, you can either send them to a new page or display a thank you messsage on the current page:', 'ddcf-plugin');
                                                          ...
                                                          <?php _e('Display thank you message:', 'ddcf-plugin') ?>
                                                            <br />
                                                            ...
                                                            <?php _e('Display contact form thank you page. Enter URL here:', 'ddcf-plugin') ?>
                                                            <br />
                                                    ...
                                                    <br />
                                                    <p>
                                                        <strong><?php _e('Error checking', 'ddcf-plugin') ?></strong>
                                                        <br /><br />
                                                        <?php
                                                            _e('Choose whether to check for user input errors either on the fly (ticks and crosses) or on submit button press.', 'ddcf-plugin');
                                                        ...
                                                        <?php _e('Check for errors on the fly', 'ddcf-plugin'); ?>
                                                        <br /><br />
                                                        ...
                                                        <?php _e('Check for errors on form submit button press', 'ddcf-plugin'); ?>
                                                    </p>
                                                </div>
						<h3>Appearance</h3>
						<div>
                                                    <p>
                                                        <strong><?php _e('CSS Theme', 'ddcf-plugin') ?></strong>
                                                        <br /><br />
                                                        <?php _e('Select a css theme for the Contact form. The custom css template (style-theme-custom.css) can be found in the plugin css folder.', 'ddcf-plugin') ?>
                                                        <br /><br />
                                                        <?php _e('Select a css theme:', 'ddcf-plugin') ?>
                                                    ...
                                                    <div id="ddcf_captcha_options">
                                                            <p>
                                                                    <strong><?php _e('reCaptcha theme', 'ddcf-plugin') ?></strong>
                                                                    <br /><br />
                                                                    <?php _e('Select the theme for the google reCaptcha:', 'ddcf-plugin') ?>
                                                    ...
                                                    <br /><br />
                                                    <p>
                                                            <strong><?php _e('UI Widget Theme', 'ddcf-plugin') ?></strong>
                                                            <br /><br />
                                                            <?php _e('Select a theme for the Contact Form jQuery-UI widgets.<br /><br />To use a custom made jQuery UI theme, name your rolled theme jquery-ui-custom.min.css and put it in the css folder in the Contacts and Bookings plugin folder.<br />To use the online theme roller to roll your own theme, see here:<br /><a href="http://jqueryui.com/themeroller/" target="_blank">http://jqueryui.com/themeroller/</a>.', 'ddcf-plugin') ?>
                                                            <br /><br />
                                                            <?php _e('Select a premade jQuery UI theme:', 'ddcf-plugin') ?>
				...
				<div id="tabs-3">
					<p>
						<?php _e('Request extra information from the contact form user.', 'ddcf-plugin') ?><br />
					</p>
					<div id="accordion3">
						<h3>Dates & Times</h3>
						<div>
							<div style="width:100%; height: 96px; margin-top:20px;">
								<div style="width:50%; float:left;">
									<?php _e('<strong>Booking Start Date / Time</strong><br /><br />', 'ddcf-plugin'); ?>
									<input type="checkbox" id="ddcf_start_date_check" name="ddcf_start_date_check" value="ddcf_start_date_check" <?php if(get_option('ddcf_start_date_check')) echo ' checked '; ?>>&nbsp;<?php _e('Request booking start date', 'ddcf-plugin'); ?>
									<br /><br />
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="ddcf_start_date_time_check" name="ddcf_start_date_time_check" value="ddcf_start_date_time_check" <?php if(get_option('ddcf_start_date_time_check')) echo ' checked '; ?>>&nbsp;<?php _e('Request booking start time', 'ddcf-plugin'); ?>
									<br /><br />
								</div>
								<div style="width:50%; float:left;">
									<?php _e('<strong>Booking End Date / Time</strong><br /><br />', 'ddcf-plugin'); ?>
									<input type="checkbox" id="ddcf_end_date_check" name="ddcf_end_date_check" value="ddcf_end_date_check" <?php if(get_option('ddcf_end_date_check')) echo ' checked '; ?>>&nbsp;<?php _e('Request booking end date', 'ddcf-plugin'); ?>
									<br /><br />
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="ddcf_end_date_time_check" name="ddcf_end_date_time_check" value="ddcf_end_date_time_check" <?php if(get_option('ddcf_end_date_time_check')) echo ' checked '; ?>>&nbsp;<?php _e('Request booking end time', 'ddcf-plugin'); ?>
									<br /><br />
								</div>
							</div>
                                                        <br /><br />
                                                        <div  style="width:100%; height:65px;;">
                                                            <?php _e('<strong>Required Field</strong>', 'ddcf-plugin'); ?>
                                                            <p>
                                                                ...
                                                                <?php _e('Dates are a required field', 'ddcf-plugin'); ?>
                                                            </p>
                                                        </div>
                                                        <br /><br />
							<div>
								<?php _e('<strong>Apply to posts in a specific category</strong><br />', 'ddcf-plugin'); ?>
								<p>
									<?php _e('You may want to only ask for dates on posts with a certain category. You can specify which category here.<br /><br />', 'ddcf-plugin'); ?>
								...
								<?php
                                                                    _e('Apply these settings to only one category: ', 'ddcf-plugin');
						...
						<h3>Party Size</h3>
                                                <div>
                                                    <div style="width:100%; height:160px; margin-top:0.7em;">
                                                        <?php _e('<strong>Request Party Size</strong><br />', 'ddcf-plugin'); ?>
                                                        <p>
                                                                <?php _e('If your contact form is being used to collect bookings, you may want to request the number of people - for example, a restaurant or hotel room booking. You can ask for the number of adults and children on the contact form using these settings.', 'ddcf-plugin'); ?>
                                                        </p><br />
                                                        <input type="checkbox" id="ddcf_extra_dropdown_one_check" name="ddcf_extra_dropdown_one_check" value="ddcf_extra_dropdown_one_check" <?php if(get_option('ddcf_extra_dropdown_one_check')) echo ' checked '; ?>>&nbsp;<?php _e('Include dropdown menu for number of adults', 'ddcf-plugin'); ?>
                                                        <br />
                                                        <br />
                                                        <input type="checkbox" id="ddcf_extra_dropdown_two_check" name="ddcf_extra_dropdown_two_check" value="ddcf_extra_dropdown_two_check" <?php if(get_option('ddcf_extra_dropdown_two_check')) echo ' checked '; ?>>&nbsp;<?php _e('Include dropdown menu for number of children', 'ddcf-plugin'); ?>
                                                    </div>
                                                        <br /><br />
                                                        <div  style="width:100%; height:50px;">
                                                            ...
                                                            <p>
                                                                ...
                                                                <?php _e('Party size is a required field', 'ddcf-plugin'); ?>
                                                            </p>
                                                        </div>
                                                        <br /><br />
							<div>
								<?php _e('<strong>Apply to posts in a specific category</strong><br />', 'ddcf-plugin'); ?>
								<p>
									<?php _e('You may want to only ask for party sizes on posts with a certain category. You can specify which category here.<br /><br />', 'ddcf-plugin'); ?>
						...
						<?php _e('<h3>Additional Questions</h3>', 'ddcf-plugin'); ?>
						<div>
							<p>
								<?php _e('If you want to add extra questions to the contact form, you can specify them here.', 'ddcf-plugin'); ?>
								<br /><br />
							</p>
							...
							<textarea class="ddcf_textarea_input" name="ddcf_extra_question_two" value="<?php echo get_option('ddcf_extra_question_two'); ?>" id="ddcf_extra_question_two" ><?php echo get_option('ddcf_extra_question_two'); ?></textarea><br />
                                                        ...
                                                        <div  style="width:100%; height:85px;">
                                                            ...
                                                            <p>
                                                                ...
                                                                <?php _e('Additional questions are a required field', 'ddcf-plugin'); ?>
                                                            </p>
                                                        </div>
							<div>
								<?php _e('<strong>Apply to posts in a specific category</strong><br />', 'ddcf-plugin'); ?>
								<p>
									<?php _e('You may want to only add extra question requests to posts within a certain category. You can specify which category here.<br /><br />', 'ddcf-plugin'); ?>
